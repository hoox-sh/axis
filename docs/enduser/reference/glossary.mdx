...
| **MCP** | Model Context Protocol. AXIS Worker `POST /mcp` plus an optional PWA bridge so agents can read/write the app. |
...
| **Pane badge** | Corner chip with script actions (settings / load source / eye / re-run / remove). |
