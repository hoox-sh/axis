...
### Built-in studies (always in the app)

Original AXIS Pine catalog — apply from **Scripts → Built-in** or ⌘K **Add built-in script…**. Not TradingView® templates. See [Built-in scripts](/axis/docs/enduser/guides/builtin-scripts).

### Pine Script™ v6 starter pack

Repo ships a portable library dump of **v6** language examples (libraries, enums, MTF):

| Path | Role |
| --- | --- |
| `examples/script-library-starter.json` | Importable library JSON (`//@version=6` helpers + sample studies) |
