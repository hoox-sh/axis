...
<img src="/images/app/results-drawer.png" alt="Results overlay showing strategy stats, equity curve, and closed trades" />
...
<img src="/images/app/results-strategy.png" alt="Strategy tab: stats cards, equity curve, and closed-trades table" />
...
| **Optimise** | Strategy-only `input.*` search — [Hyperparameter Optimisation](/axis/docs/enduser/guides/hyperparameter-optimisation) |
...
| Path | Role |
| --- | --- |
| `src/ui/ResultsPanel.tsx` | Drawer UI |
| `src/results/strategy.ts` | Trade pairing + stats |
| `src/results/events.ts` | Normalize events, markers, equity |
| `src/indicators/runner.ts` | `runAndApply` orchestration |
| `src/chart/series-factory.ts` | Plot colors / series |
