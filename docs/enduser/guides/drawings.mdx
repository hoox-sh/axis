...
<img src="/images/app/drawings-toolbar.png" alt="Left drawing tool rail: cursor, trend, shapes, fib, measure" />
...
| Path | Role |
| --- | --- |
| `src/chart/drawing-types.ts` | Tool ids, types, fib levels |
| `src/chart/drawing-layer.ts` | Interaction + render |
| `src/chart/DrawingToolbar.tsx` | UI |
| `src/chart/pyne-drawings.ts` | Map engine drawings → layer |
| `src/chart/ChartHost.tsx` | Mount / dispose |
