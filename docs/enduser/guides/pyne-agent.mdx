...
6. Pick a **persona** (`auto` detects per message): `pine` writes scripts, `axis` answers anything about the app and can change it for you (theme, layout, runs), `trader` does market analysis and risk coaching.
