...
```text
https://<your-agent-worker>/plugin/axis-pine-agent.js
```
...
If the Manager does not mount component plugins yet, open the worker’s chat UI directly:

```text
https://<your-agent-worker>/
```

or use the floating **PYNE Agent** button the plugin may inject.
...
- [Plugin deep dive](/axis/docs/plugins/pine-agent)
