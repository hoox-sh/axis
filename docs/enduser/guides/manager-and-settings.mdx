...
| --- | --- | --- |
| **Runtime** | Topbar **Runtime** · ⌘K “Open Runtime” | Active engine, endpoint, exec mode, probe of *that* backend |
...
| **Wire** | Topbar **Wire** · ⌘K “Open Architecture” | Compose slots; Apply writes `activePlugins` |
| **Settings** | Topbar gear | Appearance, chart, live, session keys, editor intel, theme |
