...
| **MCP** | **Connect this tab to MCP** (default on). Requires a Worker API key on the Data tab. Status line shows `open` / `idle` / `error`. See [MCP (agents)](/axis/docs/enduser/guides/mcp). |
