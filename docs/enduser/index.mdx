...
<img src="/images/app/workspace.png" alt="AXIS PWA shell: topbar, watchlist, chart panes, and editor" />
...
| Settings | Endpoint, engine, storage, on-chain proxy notes, MCP bridge |
| MCP | Agents on `POST /mcp` — Worker APIs + this tab ([guide](/axis/docs/enduser/guides/mcp)) |
...
- [Built-in scripts](/axis/docs/enduser/guides/builtin-scripts) — original AXIS studies (Scripts → Built-in)
...
- [MCP (agents)](/axis/docs/enduser/guides/mcp) — Claude / Cursor / Inspector on `POST /mcp`
