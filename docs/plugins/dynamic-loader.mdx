...
<img src="/images/studio/plugins-install.png" alt="Studio Plugins Install tab: ES module URL field and same-origin examples" />
...
External component example: [PYNE Agent](/axis/docs/plugins/pyne-agent) —  
...
- [PYNE Agent plugin](/axis/docs/plugins/pyne-agent)
