...
```text
https://<your-pyne-agent-worker>/plugin/axis-pine-agent.js
```
...
See also: [Dynamic loader](/axis/docs/plugins/dynamic-loader), [Plugin examples](/axis/docs/reference/plugin-examples), end-user guide [PYNE Agent](/axis/docs/enduser/guides/pine-agent).
...
- [End-user: PYNE Agent](/axis/docs/enduser/guides/pine-agent)
