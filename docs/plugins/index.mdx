...
| `component` | UI slots (phase 2 + URL agents) | `mount(slot, el, api)` — e.g. [PYNE Agent](/axis/docs/plugins/pine-agent) |
...
Works **standalone** (no pyne-worker). Full guide: [PYNE Agent plugin](/axis/docs/plugins/pine-agent) · [End-user](/axis/docs/enduser/guides/pine-agent).
