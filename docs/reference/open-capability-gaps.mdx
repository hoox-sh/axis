...
- [Architecture overview](/axis/docs/architecture/overview) — composition model
- [Strategy and results (end user)](/axis/docs/enduser/guides/strategy-and-results) — how strategy output is surfaced today
- [Debugging (UI)](/axis/docs/ui/debugging) — current debug surfaces
- [Feature atlas](/axis/docs/reference/feature-atlas) — path index for implementation work
