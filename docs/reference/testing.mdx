...
AXIS tests are **Bun-first** under the repo root, with Playwright for browser smoke and a scoped coverage ratchet. Canonical human guide: `TESTING.md`. This page is the reference map for agents and contributors.
