...
<img src="/images/app/scripts-panel.png" alt="Scripts panel listing an applied RSI indicator" />
...
- Chart pane chips mirror settings / load source / eye / re-run / remove (see [Charting](/axis/docs/ui/charting))
...
| `src/indicators/IndicatorPanel.tsx` | List UI + built-in picker |
| `src/indicators/builtins/` | Original AXIS built-in Pine catalog |
...
- [Built-in scripts](/axis/docs/enduser/guides/builtin-scripts)
