...
<img src="/images/app/editor.png" alt="CodeMirror 6 Pine editor showing a v6 RSI indicator" />
...
Icon-only (labels in tooltips / `aria-label`). **Open in new tab** is in the panel-icon menu with dock options.
...
| **Panel icon → Open in new tab** | Editor in a full browser tab (vs **New window** popup) |
