...
| `profilerEnabled` | yes | Editor profiler mode (line % when engine provides profile) |
| `panelChrome.scriptlogs` | yes | Scriptlogs panel chrome (open starts closed on hydrate for strip logs) |
