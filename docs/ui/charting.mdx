...
| `plot.style_stepline` / `stepline_diamond` | Stepline |
| `plot.style_histogram` / `columns` | Histogram |
| `plot.style_area` / `areabr` | Area |
| `plot.style_circles` | Circles / markers |
| `plot.style_linebr` / `steplinebr` | Broken line variants |
