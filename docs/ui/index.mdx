...
| --- | --- |
| [Charting](/axis/docs/ui/charting) | Panes, multi-chart, replay, compare, drawings, badges |
| [Editor](/axis/docs/ui/editor) | CM6, diagnostics, ruler, git bar, stats, dock/popout |
| [Debugging](/axis/docs/ui/debugging) | Scriptlogs, Profiler, Debug chips, Pins, Problems |
| [UI shell](/axis/docs/ui/ui-shell) | Topbar groups, docks side-by-side, palette, shortcuts, mobile shell, alerts |
| [Scripts](/axis/docs/ui/indicators) | Run pipeline, Scripts panel, overlay/sub-pane routing |
| [Results & strategy](/axis/docs/ui/results-and-strategy) | Event normalize, trades, equity, export |
...
<img src="/images/app/workspace.png" alt="AXIS UI: watchlist, multi-pane chart, and editor" />
