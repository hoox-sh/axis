...
Script `log.*` output and editor line-timing live on a separate path — see [Debugging](/axis/docs/ui/debugging). Topbar **Pine Logs** / **Profiler** do not write into `store.logs`.
