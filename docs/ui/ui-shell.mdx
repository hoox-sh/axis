...
| ArchitectureModal | `ui/ArchitectureModal.tsx` | Compose-recipe wiring (source × stream × engine × storage × dataset) |
...
| **system** | Wire (Architecture), Runtimes, Settings, Theme (`margin-left: auto`) |
