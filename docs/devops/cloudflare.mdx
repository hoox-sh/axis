...
Prefer the **[AXIS CLI](/axis/docs/devops/cli)** for setup and deploy (`axis deploy`).
...
| `ALLOWED_ORIGIN` | Extra exact origins (comma-separated); product hosts + `*.axis.pages.dev` are built-in — [CORS](/axis/docs/devops/cors-and-origins) |
