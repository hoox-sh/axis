...
`MCP_BRIDGE` Durable Object (`class_name = "McpBridgeDO"`, migration tag `v1` `new_classes`). Declared in `worker/wrangler.toml.example`. App-plane tools return `NO_MCP_BRIDGE` until this is deployed.
