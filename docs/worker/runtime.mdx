...
description: "POST /api/run — auth gate, rate limits, size caps, EXTERNAL_BACKEND proxy, feature-gated in-worker Pyodide."
---
...
- [Auth](/axis/docs/worker/auth) (Bearer when gated; metering)
- [CORS and origins](/axis/docs/devops/cors-and-origins)
- [AXIS CLI](/axis/docs/devops/cli) — `axis deploy worker` · `axis health`
