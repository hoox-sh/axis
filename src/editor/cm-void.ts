...
export const voidEditorTheme = EditorView.theme(
  {
    ...
    '.ax-fold-placeholder, .cm-foldPlaceholder': {
      backgroundColor: 'color-mix(in srgb, var(--color-accent) 12%, var(--color-bg-elev))',
    ...
    '.ax-fold-placeholder:hover, .cm-foldPlaceholder:hover': {
      color: 'var(--color-accent)',
    ...
    '.cm-pine-hover-di': {
      display: 'grid',
      gridTemplateColumns: 'minmax(4.5em, max-content) minmax(0, 1fr)',
      columnGap: '8px',
      rowGap: '1px',
      alignItems: 'baseline',
    },
    ...
    '.cm-pine-hover-pre': {
      margin: '2px 0 0',
      padding: '8px 10px',
      backgroundColor: 'color-mix(in srgb, var(--color-bg-base) 70%, var(--color-bg-panel))',
      border: '1px solid var(--color-border-soft)',
      borderRadius: '4px',
      overflow: 'auto',
      maxWidth: '100%',
    },
    '.cm-pine-hover-example': {
      backgroundColor: 'var(--color-bg-base)',
      boxShadow: 'inset 0 1px 0 var(--color-border-soft)',
    },
    ...
    '.cm-tooltip:has(.cm-pine-param-hint)': {
      border: '1px solid var(--color-border-soft)',
      borderRadius: '8px',
    },
    ...
    '.cm-pine-param-hint-sig .is-current': {
      color: 'var(--color-accent)',
      fontWeight: '700',
      backgroundColor: 'color-mix(in srgb, var(--color-accent) 14%, transparent)',
      borderRadius: '3px',
    ...
    '.cm-pine-param-hint-mark': {
      flex: '0 0 0.9em',
      textAlign: 'center',
      fontSize: '10px',
      lineHeight: '1.4',
    },
    '.cm-pine-param-hint-name': {
      fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace',
      fontSize: '11.5px',
    },
    '.cm-pine-param-hint-type': {
      fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace',
      fontSize: '10px',
      color: 'var(--color-text-faint)',
    },
    '.cm-pine-param-hint-default': {
      marginLeft: 'auto',
      fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace',
      fontSize: '10px',
      color: 'var(--color-text-faint)',
    ...
    '.cm-pine-param-hint-list li.is-used .cm-pine-param-hint-mark': {
      color: 'var(--color-text-faint)',
    },
    ...
    '.cm-pine-param-hint-more': {
      color: 'var(--color-text-faint)',
      fontSize: '10.5px',
      paddingLeft: 'calc(0.9em + 14px)',
    },
    '.cm-pine-param-hint-doc': {
      marginTop: '6px',
      paddingTop: '6px',
      borderTop: '1px solid var(--color-border-soft)',
      color: 'var(--color-text-dim)',
